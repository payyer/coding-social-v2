...
const { acceptFriendRequest, getFriendList, searchUser, getUserInfo, updateUserInfo, updateUserAvatar, updateUserCoverImage, rejectFriendRequest, unFriend, getImage, getVideo } = require("../../controller/use.controller");
